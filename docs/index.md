...
- Latest release: Version 4.0.1 — November 2024
...
- The latest version can be [downloaded from GitHub](https://github.com/LANDIS-II-Foundation/Extension-Social-Climate-Fire/blob/master/deploy/installer/LANDIS-II-V8%20Social%20Climate%20Fire%204.0.1-setup.exe). (Look for the download icon in the upper right corner.)  Launch the installer.
