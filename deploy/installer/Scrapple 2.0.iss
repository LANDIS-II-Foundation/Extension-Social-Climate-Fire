...
AppId={{DCC1F1CE-5EC6-4A78-BF7A-06FFA735A577}
...
Source: {#BuildDir}\Landis.Extension.Scrapple.dll; DestDir: {#ExtDir}; Flags: replacesameversion
Source: {#BuildDir}\Landis.Extension.Scrapple.pdb; DestDir: {#ExtDir}; Flags: replacesameversion
...
Source: {#BuildDir}\Landis.Library.BiomassCohorts-v2.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall replacesameversion
...
#define InfoTxt "Scrapple beta 2.0.txt"
