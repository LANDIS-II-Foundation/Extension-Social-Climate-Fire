...
Source: {#BuildDir}\Landis.Extension.SCRAPPLE-v2.dll; DestDir: {#ExtDir}; Flags: ignoreversion
Source: {#BuildDir}\Landis.Extension.SCRAPPLE-v2.pdb; DestDir: {#ExtDir}; Flags: ignoreversion
...
Source: {#BuildDir}\Ether.WeightedSelector.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall ignoreversion
...
Source: ..\examples\*.img; DestDir: {#AppDir}\examples\{#ExtensionName}; Flags: ignoreversion
