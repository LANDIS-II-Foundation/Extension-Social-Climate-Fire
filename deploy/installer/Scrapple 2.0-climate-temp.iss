...
#define AppVersion "2.Climate-temp"
...
Source: {#BuildDir}\Landis.Extension.SCRAPPLE-v2-climate-temp.dll; DestDir: {#ExtDir}; Flags: replacesameversion
; Source: {#BuildDir}\Landis.Extension.SCRAPPLE-v2.pdb; DestDir: {#ExtDir}; Flags: replacesameversion
